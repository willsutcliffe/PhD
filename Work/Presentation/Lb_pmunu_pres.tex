...
\end{itemize}
 ...
 \begin{itemize}
    \item Strip using $B_{s} \rightarrow K \mu \nu$ line.
    \item Remove certain cuts to investigate their impact.
    \item Acceptance given current cuts  + $P_{K} > 10$ GeV/c is:  $7.2 \pm 0.1 \%$
...
\end{center}
 ...
 \begin{itemize}
    \item Acceptance with these cuts removed is $10.0 \pm 0.1\%$.
\end{itemize}
}
...
\end{itemize}
 ...
 \frametitle{  }
  ...
  \begin{center}
    ...
    \includegraphics[width=0.5\textwidth]{Mpmu.pdf}  
\includegraphics[width=0.5\textwidth]{Enu.pdf} 

\end{center}

  \begin{center}
 
    \includegraphics[width=0.5\textwidth]{signal_Mpmu.pdf}  
\includegraphics[width=0.5\textwidth]{Enu_signal.pdf} 
...
\end{center}
 ...
 \frametitle{  }
  ...
  \begin{center}
    ...
    \includegraphics[width=1.0\textwidth]{qsquared.pdf}  
\end{center}
